...
const OnboardingModal = lazy(() => import('./authOverlays.jsx').then((mod) => ({ default: mod.OnboardingModal })));
const NoticeTray = lazy(() => import('./authOverlays.jsx').then((mod) => ({ default: mod.NoticeTray })));
const ConfirmDialog = lazy(() => import('./authOverlays.jsx').then((mod) => ({ default: mod.ConfirmDialog })));
const SystemStatusBanner = lazy(() => import('./authOverlays.jsx').then((mod) => ({ default: mod.SystemStatusBanner })));
