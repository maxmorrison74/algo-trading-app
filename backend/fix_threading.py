...
# Add lock definition right after BotState instantiation (around line 161)
if "trade_lock = threading.Lock()" not in content:
    content = content.replace("bot_state = BotState()", "bot_state = BotState()\ntrade_lock = threading.Lock()")

# We want to replace process_symbol and trading_loop
new_trading_logic = """
...
start_idx = content.find("def process_symbol(")
